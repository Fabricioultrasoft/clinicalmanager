<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../master.Master" CodeBehind="cadastrarlocal.aspx.cs" Inherits="Clinicalmanager.local.cadastrarlocal" %>

<asp:Content ID="pacCadastro" ContentPlaceHolderID="contentHolder" runat="server">
    <h1 style="margin: 5px">Cadastro de localidades</h1>
